 ...
 * 2016-11-30 17:13:00 （1，使用子线程写入文本日志；2，添加异常日志记录）
 *
 */
public class log {
    ...
    private static String log_name = "autologinIP_log";// 日志文件名（前部分）
    private static boolean console_out = false;// 日志是否输出到控制台
    /*
